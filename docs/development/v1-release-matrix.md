...
| BALL-10 | Implemented; owner calibration pending | Groundstroke and Lob offer flat/topspin/slice, Serve offers flat/slice/kick from a 2.75 m contact, and an explicitly selected Volley shot is spin-free with the opponent at the net. The Volley rail preset has separate browser/contract evidence for a net-side user camera receiving a behind-baseline Groundstroke feed. |
