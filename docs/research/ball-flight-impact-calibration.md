...
**Status:** implemented baseline for `ball-v4-shot-profiles`; real-player and instrumented-court calibration remains an external validation gate.
...
| --- | --- | --- | --- |
| Groundstroke | 1.15 m, far baseline centre | Flat, topspin, slice | 78 km/h, 0.36 m net clearance |
...
| Volley | 1.32 m, 3.7 m from the net | None | 62 km/h, 0.16 m net clearance |
