...
import { drillPracticeSetSettings, type DrillPracticeSet } from './drillPracticeSet';
...
export const defaultDrillSettings = (drill: DrillDefinition, rhythmPercent = drill.defaultRhythmPercent ?? rhythmFromLegacyInterval(drill.defaultInterval), interval = drill.defaultInterval, movementPercent = drill.defaultMovementPercent ?? 100, practiceSet?: DrillPracticeSet): SessionSettings => ({
    ...
    restSeconds: 20,
    serveRhythm: 'preset',
    ...(drill.schemaVersion === 2 && practiceSet ? drillPracticeSetSettings(drill, practiceSet) : {}),
});
