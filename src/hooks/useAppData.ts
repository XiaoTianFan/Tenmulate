...
import { removeBrowserShot } from '../storage/projectShots';
...
export const useAppData = () => {
  ...
  const deleteShot = useCallback((id: string, name?: string) => setData(current => ({...current,savedShots:removeBrowserShot(current.savedShots, id, name)})),[]);
